...
bot.command('help', async (ctx) => {
    await ctx.reply('Этот бот помогает Вам рассчитать стоимость товара из Китае в USD. А также сформировать запрос автомобильных запастей для поиска в Китае либо ОАЭ');
});
